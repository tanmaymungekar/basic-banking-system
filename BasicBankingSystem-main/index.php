...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/friend.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Welcoming you in the most trusted TSF Bank !</strong> <img src="logos/trust.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                © 2021 Copyright - Made with 🧡 by Tanmay Mungekar :
